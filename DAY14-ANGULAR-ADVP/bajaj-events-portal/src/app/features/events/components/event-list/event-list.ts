...
export class EventList implements OnInit {
  ...
  protected columns: string[] = ["event code", "event name", "start date", "fees", "show details", "cancel Events"];
  ...
  ngOnInit(): void {
    ...
    if(this.role !== 'IT'){
      this.columns = this.columns.filter(col => col.toLowerCase() !== 'cancel events');
    }
